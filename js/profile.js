...
function renderProfile() {
  ...
  var nowPlayingCard = ''
    ...
    +   '</div>'
    +   '<iframe class="now-playing-embed" src="https://open.spotify.com/embed/track/2Vtb7ciAzKB84bhrOhV09K?utm_source=generator" height="80" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>'
