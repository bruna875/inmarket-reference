...
function renderLoader() {
  return '<div style="display:flex;align-items:center;justify-content:center;height:70vh;flex-direction:column;gap:20px">'
    + '<style>'
    ...
    + '</style>'
    + '<svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg" style="animation:ld-bob 2s ease-in-out infinite">'
    ...
    + '<circle cx="51.5" cy="58" r="2.5" fill="#2A3A1A" style="animation:ld-blink 4s ease infinite"/>'
    + '<circle cx="71.5" cy="58" r="2.5" fill="#2A3A1A" style="animation:ld-blink 4s ease infinite"/>'
    ...
    + '<path d="M100 36 A8 8 0 0 1 108 44" stroke="var(--accent)" stroke-width="2" stroke-linecap="round" fill="none" style="transform-origin:100px 44px;animation:ld-spin 1s linear infinite"/>'
    + '</svg>'
    + '<div style="position:relative;height:20px;width:360px;overflow:hidden">'
