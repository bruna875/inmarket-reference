...
var OB_STEPS = [
  ...
  },
  {
    ...
    desc: 'Endorsements from key colleagues. Each page has a quote and a signature slot \u2014 in case someone feels called to make amends, since there is no expectations that face-to-face interactions will be dared. Happy to be proven wrong. Formal letters preventing potential retaliating initiatives also appreciated.',
    position: 'right'
  },
  {
    target: '.sbfoot',
