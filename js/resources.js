...
var _wizItemsPatterns = [
  ...
  },
  {
    ...
    desc: '<b>When someone finally exits \u2014 obviously pushed \u2014 and regains control over the narrative,a new wound opens.</b> The departure itself is experienced as an act of aggression. After everything that had been done to make that person leave, the act of leaving is still taken personally. <b>Brought to the very next level.</b> Their anger is not emotional, it starts feeling psychopatic. Earlier, the rage was cruel and manipulative, but now is colder, darker, and more detached. You no longer feel like you are dealing with a hurt ego, you feel like you are standing in front of somebody who could enjoy destroying the entire structure of your life: they go after your finances, your career, your support system. They are not just emotionally toxic, they are dangerous in a much more serious way. <b>Eh no! Not this time, so sorry! Kindness is a choice, not a weakness, and can be retired at any time. </b>'
  },
  {
    label: 'Final Quiz',
  ...
  },
  {
    ...
    html: '<div class="emp-intro">Before you close this chapter \u2014 one more thing.</div>'
      ...
      + '<div class="emp-card"><div class="emp-emoji">🪞</div><div class="emp-num">2</div><div class="emp-text">Replace the victim\u2019s face with the one of your beloved ones: your daughter, your son, your mum, your dad, your wife, your husband, your niece. Imagine them coming back home every day from work for 12 months after this treatment, trying to sleep in the bed with you, or being happy at a Christmas dinner.</div></div>'
      + '<div class="emp-connector"><svg width="10" height="10" viewBox="0 0 12 12" fill="none"><path d="M2 6h8M7 3l3 3-3 3" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></div>'
      ...
      + '<div class="emp-card"><div class="emp-emoji">🕊️</div><div class="emp-num">5</div><div class="emp-text">Despite all... be compassionate. People of integrity stay solid. Pigs stay in their smear. And you... where do you stand?</div></div>'
...
function renderResources() {
  ...
  return '<div class="ptitle">Recognize the Patterns</div>'
    + '<div class="psub psub-row">A guided journey through a very specific dynamic...'
