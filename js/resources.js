...
function renderBoilingFrog() {
  ...
  return '<div class="ptitle">The Boiling Frog</div>'
    ...
    + '<div class="frog-quote">'
    + '<div class="frog-quote-text">\u201cThe most dangerous things in an organization are not the ones people argue about. They are the ones nobody mentions anymore.\u201d</div>'
    + '</div>'
