...
var MARSHALL_RESPONSES = [
  ...
  "Okay so let me break this down for you in simple terms. The ROI is the problem. It's always the ROI. Don Michele told me the same thing last week and he's never wrong.",
  ...
  "That's a very entry-level question. No offense. But as a Leader, I've already internalized the answer. It's about maximizing ROI. Full stop. Obviously.",
  ...
  "So essentially what you're asking is a ROI question disguised as a strategy question. I see through these things because that's what Leadership gives you \u2014 clarity.",
  ...
  "Interesting question. Not as interesting as you think it is. A true Leader would reframe this as a ROI challenge. Which is what I just did for you.",
  ...
  "The ROI on this is all wrong. I can tell just by looking at it. Don Michele told me he had the same instinct and he's been in ROI for \u2014 actually I don't know how long. Long enough.",
  "Oh hold on, Paolo DiTaddeo is calling me I have to go. But before I do: the ROI story here is clear. You need to 10x the Leadership alignment on ROI. That's my final answer.",
  "I don't mean to mansplain \u2014 actually, yes I do. Someone has to. The real issue is that your Leadership team hasn't thought about ROI. Unlike me. I think about it daily.",
  ...
  "I'm not saying I'm always right. I'm saying the ROI of listening to me has been historically positive. Ask Don Michele. Or Paolo DiTaddeo. Actually Paolo DiTaddeo is calling me I have to go.",
  "That's cute. You think that's a hard problem. When Don Michele and I cracked this exact ROI model at [REDACTED], we delivered 500% returns. Before lunch. Leadership.",
  "Quick answer because Paolo DiTaddeo is calling me I have to go: it's a Leadership gap. The ROI is there but nobody is Leading. Except me. When I'm available. Which is now. Actually no, Paolo DiTaddeo is calling.",
  "Don Michele told me \u2014 and I quote \u2014 'Maresciallo, you're the only one who truly gets ROI.' I didn't ask for the compliment. Leaders don't. It just happens.",
  "See, this is exactly why Leadership matters. Without someone like me to anchor everything to ROI, teams just wander. Don Michele saw it too. He called it 'the Maresciallo effect'.",
  "Real quick before Paolo DiTaddeo calls me again: the ROI on this initiative is negative. I know because I've seen this pattern fourteen times. Fifteen now. Leadership.",
