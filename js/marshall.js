...
var MARSHALL_RESPONSES = [
  ...
  "Okay so let me break this down for you in simple terms. The UX is the problem. It's always the UX. Don Michele (famous mafia boss) told me the same thing last week and he's never wrong.",
  ...
  "Don Michele (famous mafia boss) told me something very relevant to this at dinner last Thursday. I can't share the details \u2014 NDA \u2014 but trust me, the ROI implications are massive.",
  ...
  "Sorry, Todd is calling me I have to go, but real quick: the answer is ROI. It's always ROI. When in doubt, ROI. Don Michele (famous mafia boss) agrees. Gotta run.",
  "With all due respect, this is a solved problem. I solved it. The ROI was 340%. Don Michele (famous mafia boss) said it was the best execution he'd ever seen. His words, not mine.",
  ...
  "The UX on this is all wrong. I can tell just by looking at it. Don Michele (famous mafia boss) told me he had the same instinct and he's been in UX for \u2014 actually I don't know how long. Long enough.",
  ...
  "Oh, this? I literally solved this in my head while you were still typing. It's intuitive for Leaders who understand ROI. Don Michele (famous mafia boss) calls it 'the instinct'. I have it.",
  "You know what your problem is? You're thinking like someone who doesn't understand ROI. Think like a Leader. Think like Don Michele (famous mafia boss). Think like me. Problem solved.",
  "I'm not saying I'm always right about UX. I'm saying the ROI of listening to me has been historically positive. Ask Don Michele (famous mafia boss). Or Todd. Actually Todd is calling me I have to go.",
  "That's cute. You think that's a hard problem. When Don Michele (famous mafia boss) and I redesigned the entire UX at [REDACTED], we delivered 500% ROI. Before lunch. Leadership.",
  ...
  "Don Michele (famous mafia boss) told me \u2014 and I quote \u2014 'Maresciallo, you're the only one who gets UX and ROI at the same time.' I didn't ask for the compliment. Leaders don't. It just happens.",
  "See, this is exactly why Leadership matters. Without someone like me connecting the dots between UX and ROI, teams just wander. Don Michele (famous mafia boss) saw it too. He called it 'the Maresciallo effect'.",
  ...
  "I appreciate the question. I really do. But a Leader would already know the answer. The ROI speaks for itself. Don Michele (famous mafia boss) would agree. Todd would too but he's always on the phone."
];
