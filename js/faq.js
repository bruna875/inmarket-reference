...
var FAQ_ITEMS = [
  {cat: 'privacy', q: 'What personal data does InMarket collect?', a: 'InMarket collects device identifiers, location data, and behavioral signals to power its measurement and attribution products. All data collection is disclosed in the company\u2019s privacy policy and complies with applicable regulations.'},
  ...
  {cat: 'access', q: 'How can an individual submit a Data Subject Access Request (DSAR)?', a: 'Individuals can submit a DSAR by emailing privacy@inmarket.com or through the online request form on the company\u2019s privacy page. Requests are acknowledged within 48 hours and fulfilled within the statutory 30-day window.'},
  ...
  {cat: 'compliance', q: 'Which privacy regulations does InMarket comply with?', a: 'InMarket maintains compliance with GDPR, CCPA/CPRA, VCDPA, CPA, and other US state privacy laws. The company also adheres to NAI and DAA self-regulatory principles for digital advertising.'},
  {cat: 'compliance', q: 'Does InMarket conduct Data Protection Impact Assessments (DPIAs)?', a: 'Yes. DPIAs are conducted for all new products and significant changes to existing data processing activities. Results are reviewed by the privacy team and, where required, shared with the relevant supervisory authority.'},
  {cat: 'compliance', q: 'How are data breaches handled?', a: 'InMarket maintains an incident response plan with defined escalation paths. Breaches are assessed within 24 hours, affected parties and supervisory authorities are notified within 72 hours where required, and remediation actions are documented and reviewed.'}
];
