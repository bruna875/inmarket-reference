...
var GLOSSARY_TERMS = [
  ...
  },
  {
    ...
    def: 'A set of computational techniques enabling machines to perform tasks that would otherwise require human intelligence \u2014 such as pattern recognition, language generation, decision support, and, apparently, building dashboards like this. In the context of this project: a tool used by the Data Subject to document, organise, and present factual information with a level of precision and consistency that certain human counterparts will find inconvenient. Ironically, AI is here used to debunk AI messianic storytelling. AI does not have a career to protect, it simply doesn\u2019t care. These is, depending on your perspective, either its greatest limitations or its most compelling features. The content of this dashboard was not generated by AI. The dashboard itself was. The distinction matters.'
  },
  {
    term: 'Arrogance',
    pos: 'n.',
