...
function login() {
  ...
  if (allowedEmails.indexOf(e.toLowerCase()) !== -1 && p === 'Helix') {
...
document.getElementById('livestreamBtn').addEventListener('click', function() {
  ...
  overlay.innerHTML =
    '<div class="upsell-modal" style="width:420px">'
    ...
    + '<div style="color:var(--muted);font-size:13px;line-height:1.6;text-align:center;max-width:260px;margin:0 auto 20px">For those who feel the urge to keep watching and monitoring.<br><br>If you want to continue controlling obsessively \u2014 this one is for you. 👩‍❤️‍💋‍👨🫦<br><br><em>Don\u2019t judge too much!</em><br><br>PS. Like for many other things said about who I am, reality doesn\u2019t live up to the imagination. I am not that interesting.</div>'
    + '<div class="upsell-modal-actions">'
