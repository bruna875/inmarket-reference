...
var GLOSSARY_TERMS = [
  ...
  },
  {
    term: 'Tinkerer Kid',
    pos: 'n.',
    def: 'An enthusiastic junior practitioner who mistakes access to tooling for expertise, and the ability to ship something functional for the capacity to think systemically. Typically a decade younger than the people they are supposed to replace, with the energy of someone who has not yet experienced ten additional years of Condominium dynamics and dysfunctional organizational design. Their work \u2014 invariably framed as Rocket Science, a paradigm shift, or a once-in-a-generation technical achievement \u2014 tends, upon closer inspection, to consist of well-documented Google APIs stitched together in the obvious sequence. The messianic narrative is inversely proportional to the complexity of what was actually built. Their defining characteristic is, precisely by virtue of their youth, the absence of a solid professional independence \u2014 and, consequently, the absence of any tangible threat. Not to be confused with a senior professional, who solves the same problem quietly, ships it without a press release or a company-wide meeting, and has been doing so for ten years before the tinkerer kid discovered the internet.'
  },
  {
    term: 'Substance',
    pos: 'n.',
